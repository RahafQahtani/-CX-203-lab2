...
HD_PWD='/home/it/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log K2_Microprosser.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source K2_Microprosser.tcl

...
HD_PWD='/home/it/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log K2_Microprosser.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source K2_Microprosser.tcl -notrace
